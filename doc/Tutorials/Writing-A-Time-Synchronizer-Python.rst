...
.. code-block:: Python
    ...
    class TimeSyncNode(Node):
        ...
        def __init__(self):
            ...
            self.sync = TimeSynchronizer([self.temp_sub, self.fluid_sub], 10)
