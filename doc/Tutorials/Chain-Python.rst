...
For more information on this topic, please refer to the `SimpleFilter for Python tutorial <https://docs.ros.org/en/humble/p/message_filters/doc/Tutorials/SimpleFilter-Python.html>`.
...
For more information on this succession mechanism, please refer to the `SimpleFilter for Python tutorial <https://docs.ros.org/en/humble/p/message_filters/doc/Tutorials/SimpleFilter-Python.html>`.
